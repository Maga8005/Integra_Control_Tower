...
import FKDashboard from '../components/ui/FKDashboard';
...
export default function Dashboard() {
  ...
  const handleRoleSwitch = () => {
    // For demo purposes - in real app this would be a proper role switch flow
    logout();
    navigate('/login', { replace: true });
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              {/* Notifications */}
              <NotificationBell 
                onClick={() => showInfo('Notificaciones', 'Panel de notificaciones disponible próximamente')}
              />
              ...
              <div className="flex items-center gap-3">
                ...
                {/* User Menu Dropdown - Simplified for MVP */}
