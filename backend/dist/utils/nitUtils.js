...
exports.normalizeNit = normalizeNit;
exports.extractClienteNitFromDocColumn = extractClienteNitFromDocColumn;
exports.extractNitFromDocColumn = extractNitFromDocColumn;
exports.findOperationsByNit = findOperationsByNit;
exports.generateClientToken = generateClientToken;
exports.validateNitFormat = validateNitFormat;
...
function extractClienteNitFromDocColumn(docuClienteValue) {
 ...
 */
function extractNitFromDocColumn(docuClienteValue) {
 ...
 */
function findOperationsByNit(csvData, searchNit) {
    ...
    for (const row of csvData) {
        ...
        const partialMatch = extractedNits.some(nit => nit.includes(normalizedSearchNit) || normalizedSearchNit.includes(nit));
    ...
    const operations = matchingRows.map(row => (0, csvMappers_1.mapCSVToOperationCard)(row));
    // Crear información del cliente
    const clientInfo = operations.length > 0 ? {
        nit: searchNit,
 ...
 */
function generateClientToken(clientInfo) {
 ...
 */
function validateNitFormat(nit) {
...
//# sourceMappingURL=nitUtils.js.map